...
% Drop cube 1 to basket1
setGripper(0);
% Move to p3, which is above cube 2
for i=1:num_pts
    setAngles(q_2_3(i, :), 0.02);
end
% Move down and pick up cube 2
setAngles(q4, 0.01);
setGripper(1);
% Move to p5, which is above basket 2
for i=1:num_pts
    setAngles(q_4_5(i, :), 0.02);
end
% drop cube 2 to basket 2
setGripper(0);
